...
export const adminTranslations = {
  fr: {
    ...
    "mediaGallery.clickToEnlarge": "Cliquer pour agrandir",
    "mediaGallery.expandView": "Agrandir",
    "mediaGallery.closeExpandedView": "Fermer la vue élargie",
    "mediaGallery.noMediaAvailable": "Aucun média disponible",
    "mediaGallery.loadingError": "Erreur de chargement",
    "mediaGallery.unknownFile": "Fichier inconnu",
    "mediaGallery.play": "Lire",
    "mediaGallery.pause": "Pause",
    "mediaGallery.toggleFullscreen": "Basculer en plein écran",
    "mediaGallery.download": "Télécharger",
    "mediaGallery.unableToLoadImage": "Impossible de charger l'image",
    "mediaGallery.failedToOpenPreview": "Échec de l'ouverture de l'aperçu",
    "mediaGallery.invalidDownloadUrl": "URL de téléchargement invalide",
    "mediaGallery.downloadFailed": "Échec du téléchargement",
    ...
    // Email Reply System translations
    "emailReply.replyTo": "Répondre à {name}",
    "emailReply.composeAndSend": "Composer et envoyer une réponse pour cette soumission",
    "emailReply.composeTab": "Composer",
    "emailReply.previewTab": "Aperçu",
    "emailReply.subject": "Objet",
    "emailReply.subjectLabel": "Objet :",
    "emailReply.template": "Modèle",
    "emailReply.selectTemplate": "Sélectionner un modèle",
    "emailReply.message": "Message",
    "emailReply.messagePlaceholder": "Tapez votre message de réponse ici...",
    "emailReply.characters": "caractères",
    "emailReply.messageTip": "Conseil : Utilisez **texte** pour le gras, *texte* pour l'italique",
    "emailReply.cancel": "Annuler",
    "emailReply.sendReply": "Envoyer la réponse",
    "emailReply.sending": "Envoi...",
    "emailReply.replySent": "Réponse envoyée avec succès !",
    "emailReply.replyError": "Erreur lors de l'envoi de la réponse",
    "emailReply.pleaseEnterMessage": "Veuillez entrer un message",
    "emailReply.originalMessage": "Message original",
    "emailReply.originalMessageLabel": "Message original :",
    "emailReply.from": "De",
    "emailReply.fromLabel": "De :",
    "emailReply.language": "Langue",
    "emailReply.languageLabel": "Langue :",
    "emailReply.edit": "Modifier",
    "emailReply.tip": "Astuce",
    "emailReply.templateTip": "Ce modèle fournit une structure de base. Personnalisez le message selon vos besoins.",
    "emailReply.templates.standard": "Réponse standard",
    "emailReply.templates.standardDesc": "Réponse professionnelle avec tous les détails",
    "emailReply.templates.quick": "Réponse rapide",
    "emailReply.templates.quickDesc": "Accusé de réception bref",
    "emailReply.templates.detailed": "Réponse détaillée",
    "emailReply.templates.detailedDesc": "Explication complète et prochaines étapes",
    "emailReply.templates.followup": "Suivi",
    "emailReply.templates.followupDesc": "Message de suivi après traitement initial",
    "emailReply.composeReplyButton": "Composer une réponse",
    "emailReply.replyPanelExpanded": "Panneau de réponse étendu",
    "emailReply.replyPanelCollapsed": "Panneau de réponse réduit",
    "emailReply.replyInterface": "Interface de réponse aux emails",
    "emailReply.emailLanguage": "Langue de l'email",
    "emailReply.closeDialog": "Fermer la boîte de dialogue",
  },
  ar: {
    // Plugin-generated collections
    general: {
    ...
    "mediaCleanupJobs.dashboardSubtitle": "أتمتة تنظيف الملفات اليتيمة وتحسين مساحة تخزين R2",
    ...
    "mediaCleanupJobs.directoriesToScan": "المجلدات المطلوب فحصها",
    "mediaCleanupJobs.labelsPlaceholderDirectories": "forms/, images/, docs/",
    "mediaCleanupJobs.directoriesToScanDesc": "اتركه فارغاً لفحص جميع مجلدات R2",
    "mediaCleanupJobs.maxFilesToProcess": "الحد الأقصى للملفات المعالجة",
    "mediaCleanupJobs.retentionPeriod": "فترة الاحتفاظ (أيام)",
    "mediaCleanupJobs.retentionPeriodDesc": "سيتم الاحتفاظ بالملفات الأحدث",
    "mediaCleanupJobs.dryRunMode": "وضع التجربة (بدون حذف)",
    "mediaCleanupJobs.totalScanned": "إجمالي الملفات المفحوصة",
    "mediaCleanupJobs.filesChecked": "الملفات المتحققة",
    "mediaCleanupJobs.orphanedFound": "الملفات اليتيمة الموجودة",
    "mediaCleanupJobs.orphanedIdentified": "الملفات اليتيمة المحددة",
    "mediaCleanupJobs.filesDeleted": "الملفات المحذوفة",
    "mediaCleanupJobs.successfullyDeleted": "تم حذفها بنجاح",
    "mediaCleanupJobs.storageReclaimed": "المساحة المستردة",
    "mediaCleanupJobs.unitsBytes": "بايت",
    "mediaCleanupJobs.unitsKilobytes": "كيلوبايت",
    "mediaCleanupJobs.unitsMegabytes": "ميجابايت",
    "mediaCleanupJobs.unitsGigabytes": "جيجابايت",
    "mediaCleanupJobs.totalSpaceReclaimed": "إجمالي المساحة المستردة",
    "mediaCleanupJobs.scanResults": "نتائج الفحص",
    "mediaCleanupJobs.foundOrphaned": "ملفات يتيمة موجودة",
    "mediaCleanupJobs.labelsTotal": "إجمالي",
    "mediaCleanupJobs.selectAll": "تحديد الكل",
    "mediaCleanupJobs.cleaningInProgress": "جاري التنظيف...",
    "mediaCleanupJobs.cleanupSelected": "تنظيف المحدد",
    ...
    "mediaCleanupJobs.jobHistory": "تاريخ المهام",
    "mediaCleanupJobs.filesScanned": "الملفات المفحوصة",
    "mediaCleanupJobs.deletionErrors": "أخطاء",
    "mediaCleanupJobs.fieldsJobTypeLabel": "نوع المهمة",
    "mediaCleanupJobs.fieldsStatusLabel": "الحالة",
    "mediaCleanupJobs.executedAt": "تم تنفيذها في",
    "mediaCleanupJobs.completedAt": "تم إنجازها في",
    ...
    "mediaCleanupJobs.statusPartial": "جزئي",
    "mediaCleanupJobs.jobTypesVerification": "التحقق",
    "mediaCleanupJobs.jobTypesCleanup": "التنظيف",
    "mediaCleanupJobs.jobTypesAudit": "المراجعة",
    "mediaCleanupJobs.messagesFoundOrphanedFiles": "تم العثور على {count} ملف يتيم",
    "mediaCleanupJobs.errorsScanFailed": "فشل الفحص",
    "mediaCleanupJobs.errorsNoFilesSelected": "لم يتم تحديد أي ملفات",
    "mediaCleanupJobs.messagesDryRunCompleted": "تم الاختبار - سيتم حذف {count} ملف",
    "mediaCleanupJobs.messagesFilesDeleted": "تم حذف {count} ملف بنجاح",
    "mediaCleanupJobs.errorsCleanupFailed": "فشل التنظيف",
    ...
    "mediaGallery.clickToEnlarge": "انقر للتكبير",
    "mediaGallery.expandView": "توسيع",
    "mediaGallery.closeExpandedView": "إغلاق العرض الموسع",
    "mediaGallery.noMediaAvailable": "لا توجد ملفات وسائط متاحة",
    "mediaGallery.loadingError": "خطأ في التحميل",
    "mediaGallery.unknownFile": "ملف غير معروف",
    "mediaGallery.play": "تشغيل",
    "mediaGallery.pause": "إيقاف",
    "mediaGallery.toggleFullscreen": "تبديل ملء الشاشة",
    "mediaGallery.download": "تحميل",
    "mediaGallery.unableToLoadImage": "غير قادر على تحميل الصورة",
    "mediaGallery.failedToOpenPreview": "فشل في فتح المعاينة",
    "mediaGallery.invalidDownloadUrl": "رابط التحميل غير صحيح",
    "mediaGallery.downloadFailed": "فشل التحميل",
    ...
    // Email Reply System translations (Arabic)
    "emailReply.replyTo": "الرد على {name}",
    "emailReply.composeAndSend": "إنشاء وإرسال رد على هذا الطلب",
    "emailReply.composeTab": "إنشاء",
    "emailReply.previewTab": "معاينة",
    "emailReply.subject": "الموضوع",
    "emailReply.subjectLabel": "الموضوع:",
    "emailReply.template": "القالب",
    "emailReply.selectTemplate": "اختر قالباً",
    "emailReply.message": "الرسالة",
    "emailReply.messagePlaceholder": "اكتب رسالة الرد هنا...",
    "emailReply.characters": "حرف",
    "emailReply.messageTip": "نصيحة: استخدم **النص** للخط العريض، *النص* للخط المائل",
    "emailReply.cancel": "إلغاء",
    "emailReply.sendReply": "إرسال الرد",
    "emailReply.sending": "جاري الإرسال...",
    "emailReply.replySent": "تم إرسال الرد بنجاح!",
    "emailReply.replyError": "خطأ في إرسال الرد",
    "emailReply.pleaseEnterMessage": "الرجاء إدخال رسالة",
    "emailReply.originalMessage": "الرسالة الأصلية",
    "emailReply.originalMessageLabel": "الرسالة الأصلية:",
    "emailReply.from": "من",
    "emailReply.fromLabel": "من:",
    "emailReply.language": "اللغة",
    "emailReply.languageLabel": "اللغة:",
    "emailReply.edit": "تعديل",
    "emailReply.tip": "نصيحة",
    "emailReply.templateTip": "يوفر هذا القالب بنية أساسية. قم بتخصيص الرسالة حسب احتياجاتك.",
    "emailReply.templates.standard": "رد قياسي",
    "emailReply.templates.standardDesc": "رد مهني مع جميع التفاصيل",
    "emailReply.templates.quick": "رد سريع",
    "emailReply.templates.quickDesc": "إشعار استلام مختصر",
    "emailReply.templates.detailed": "رد مفصل",
    "emailReply.templates.detailedDesc": "شرح كامل والخطوات التالية",
    "emailReply.templates.followup": "متابعة",
    "emailReply.templates.followupDesc": "رسالة متابعة بعد المعالجة الأولية",
    "emailReply.composeReplyButton": "إنشاء رد",
    "emailReply.replyPanelExpanded": "لوحة الرد موسعة",
    "emailReply.replyPanelCollapsed": "لوحة الرد مطوية",
    "emailReply.replyInterface": "واجهة الرد على البريد الإلكتروني",
    "emailReply.emailLanguage": "لغة البريد الإلكتروني",
    "emailReply.closeDialog": "إغلاق مربع الحوار",
  },
};
