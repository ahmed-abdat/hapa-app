...
export const adminTranslations = {
  fr: {
    ...
    // MediaCleanupJobs translations
    "mediaCleanupJobs.dashboardTitle": "Gestion du Nettoyage des Médias",
    "mediaCleanupJobs.dashboardSubtitle": "Automatiser le nettoyage des fichiers orphelins et optimiser l'espace de stockage R2",
    "mediaCleanupJobs.settings": "Paramètres",
    "mediaCleanupJobs.scanning": "Scan en cours",
    "mediaCleanupJobs.scanForOrphaned": "Analyser les Fichiers Orphelins",
    ...
    "mediaCleanupJobs.directoriesToScanDesc": "Laisser vide pour scanner tous les répertoires R2",
    "mediaCleanupJobs.maxFilesToProcess": "Maximum de Fichiers à Traiter",
    "mediaCleanupJobs.retentionPeriod": "Période de Rétention (jours)",
    "mediaCleanupJobs.retentionPeriodDesc": "Les fichiers plus récents seront conservés",
    "mediaCleanupJobs.dryRunMode": "Mode Test (sans suppression)",
    "mediaCleanupJobs.totalScanned": "Total Scanné",
    "mediaCleanupJobs.filesChecked": "Fichiers vérifiés",
    ...
    "mediaCleanupJobs.unitsBytes": "octets",
    ...
    "mediaCleanupJobs.selectAll": "Tout sélectionner",
    "mediaCleanupJobs.cleaningInProgress": "Nettoyage en cours...",
    "mediaCleanupJobs.cleanupSelected": "Nettoyer la Sélection",
    "mediaCleanupJobs.fieldsOrphanedFilesFilename": "Nom de fichier",
    ...
    "mediaCleanupJobs.deletionErrors": "erreurs",
    "mediaCleanupJobs.fieldsJobTypeLabel": "Type de tâche",
    "mediaCleanupJobs.fieldsStatusLabel": "Statut",
    "mediaCleanupJobs.executedAt": "Exécuté à",
    "mediaCleanupJobs.completedAt": "Terminé à",
    "mediaCleanupJobs.executionLog": "Journal d'exécution",
    "mediaCleanupJobs.errorLog": "Journal des erreurs",
    "mediaCleanupJobs.statusPending": "En attente",
    "mediaCleanupJobs.statusRunning": "En cours",
    "mediaCleanupJobs.statusCompleted": "Terminé",
    "mediaCleanupJobs.statusFailed": "Échec",
    "mediaCleanupJobs.statusPartial": "Partiel",
    "mediaCleanupJobs.jobTypesVerification": "Vérification",
    "mediaCleanupJobs.jobTypesCleanup": "Nettoyage",
    "mediaCleanupJobs.jobTypesAudit": "Audit",
    "mediaCleanupJobs.messagesFoundOrphanedFiles": "{count} fichiers orphelins trouvés",
    "mediaCleanupJobs.errorsScanFailed": "Échec du scan",
    "mediaCleanupJobs.errorsNoFilesSelected": "Aucun fichier sélectionné",
    "mediaCleanupJobs.messagesDryRunCompleted": "Test terminé - {count} fichiers seraient supprimés",
    "mediaCleanupJobs.messagesFilesDeleted": "{count} fichiers supprimés avec succès",
    "mediaCleanupJobs.errorsCleanupFailed": "Échec du nettoyage",
