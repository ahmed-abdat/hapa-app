  ...
  return (
    <div className="hidden lg:flex items-center gap-8">
      ...
      <div className="flex items-center gap-action-gap">
        ...
        <Button 
          className="bg-secondary-cta hover:bg-secondary-cta/90 text-secondary-cta-foreground font-semibold px-4 py-2 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 text-sm border-0 focus:ring-2 focus:ring-ring focus:ring-offset-2"
          asChild
        >
