    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
        <SheetHeader className="p-6 bg-gradient-to-r from-primary to-primary/80">
          <SheetTitle asChild>
            <Link href={`/${validLocale}`} className={`flex items-center gap-3 text-white`} onClick={closeSheet}>
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-white/80">
                  {validLocale === 'ar' ? 'الهيئة العليا للصحافة والإعلام' : 'Mauritanie'}
                </span>
              </div>
            </Link>
          </SheetTitle>
          ...
          <div className="space-y-4">
            ...
            <nav className="space-y-2">
              ...
              >
                ...
                <span className="font-medium">{validLocale === 'ar' ? 'الخدمات' : 'Services'}</span>
              </Link>
              ...
              >
                ...
                <span className="font-medium">{validLocale === 'ar' ? 'بحث' : 'Rechercher'}</span>
              </Link>
            </nav>
          </div>
        </div>
